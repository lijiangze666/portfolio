...
import {officialDataLeft, officialDataRight} from "@/data"
...
export const BentoGridItem = ({
    ...
    // const rightLists = ["VueJS", "EtherJS", "Java"];

    const [copied, setCopied] = useState(false);


    const handleCopy = () => {
        const text = "lijz88917@gmail.com";
                ...
                >
                    ...
                    {id === 5 && (
                        <div className=" gap-1 lg:gap-5 w-fit flex lg:mt-20 md:mt-20 lg:-right-2 mt-20">
                                ...
                                {officialDataLeft.map((item, idx) => (
                                    <div key={idx} className="flex flex-wrap justify-center items-center">
                                        ...
                                        <Link
                                            ...
                                            className=" w-full lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E] flex items-center"
                                        >
                                            <Image src={item.img} alt={item.name} width={30} height={30}
                                                   className="flex mr-3 "/>
                                             <span className="underline text-white underline-offset-4">
                                                {item.name}
                                             </span>
                                            <FaLink className="ml-0.5"/>
                                        </Link>
                                    </div>
                            ...
                            {/* tech stack lists */}
                            <div className="flex flex-col gap-3 mt-4 md:-mt-2 md:gap-3 lg:gap-8 ">
                                {officialDataRight.map((item, idx) => (
                                    <div key={idx} className="flex flex-wrap justify-center items-center">
